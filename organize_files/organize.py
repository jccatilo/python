...
def moveFiles():
    MAIN = r"C:/Users/User\Desktop/python/organize files/temp"
...
def organizeFiles():
    path = r"C:/Users/User/Desktop/python/organize files/temp"
...
print(".")
print(".")
print("Organizing done. View \"folders\" folder for your files sorted according to their extension.") 
